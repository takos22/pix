...
const pickCertificationChallenges = async function (placementProfile, locale) {
...
const pickCertificationChallengesForPixPlus = async function (campaignId, badgeKey, userId, locale) {
