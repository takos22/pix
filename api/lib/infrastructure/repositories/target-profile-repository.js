...
const createWithTubes = async function ({ targetProfileForCreation, domainTransaction }) {
...
const updateTargetProfileWithSkills = async function ({ targetProfileId, skills, domainTransaction }) {
  const knexConn = domainTransaction.knexTransaction;
...
const getTargetProfileSkillIdsByCampaignId = async function (campaignId, domainTransaction) {
...
const getTargetProfileSkillIds = async function (targetProfileId, domainTransaction) {
  const knexConn = domainTransaction?.knexTransaction ?? knex;
...
const findStages = async function ({ targetProfileId }) {
...
export {
  createWithTubes,
  updateTargetProfileWithSkills,
  get,
  getByCampaignId,
  getTargetProfileSkillIdsByCampaignId,
  getTargetProfileSkillIds,
  findByIds,
  update,
  findOrganizationIds,
  hasSkills,
