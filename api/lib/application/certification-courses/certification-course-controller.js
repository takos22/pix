...
const getCertificationDetails = async function (request) {
...
const getJuryCertification = async function (request) {
  const certificationCourseId = request.params.id;
...
const getCertifiedProfile = async function (request) {
  const certificationCourseId = request.params.id;
...
const saveAssessmentResult = async function (request) {
