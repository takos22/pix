...
module('Integration | Component | feedback-panel', function (hooks) {
  ...
  module.only('When FeedbackPanel is rendered initially opened (e.g. in a comparison-window)', function (hooks) {
    hooks.beforeEach(async function () {
      const assessment = { id: 'assessment_id' };
      const challenge = { id: 'challenge_id' };
  ...
  module.only('When FeedbackPanel is rendered initially closed (e.g. in a challenge)', function (hooks) {
    hooks.beforeEach(async function () {
      const assessment = { id: 'assessment_id' };
      const challenge = { id: 'challenge_id' };
